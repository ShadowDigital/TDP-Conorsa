...
import { HiOutlineDocumentArrowDown, HiOutlineCalendar, HiOutlineTrash } from 'react-icons/hi2';
          ...
          <div className="p-8 space-y-8">
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <button
                ...
                className="px-6 py-4 bg-white text-slate-500 rounded-2xl font-bold hover:bg-slate-50 border border-slate-200 disabled:opacity-40 transition-all flex items-center justify-center gap-2"
