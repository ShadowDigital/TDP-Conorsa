    ...
    <MainLayout title={isEdit ? 'Editar Producto' : 'Nuevo Producto'}>
      <div className="max-w-4xl mx-auto">
        <div className="mb-6 flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-slate-900">{isEdit ? 'Editar Producto' : 'Crear Producto'}</h1>
            <p className="text-slate-500 text-sm">Gestiona la información del producto y sus componentes.</p>
          </div>
        </div>
